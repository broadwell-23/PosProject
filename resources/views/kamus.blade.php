  ...
  <div class="panel">
    <div class="panel-heading border">
      <ol class="breadcrumb mb0 no-padding">
        ...
        <li class="active">Kamus Istilah</li>
      </ol>
    </div>
      ...
      <div class="modal-body">
        <form method="POST" class="form-horizontal" role="form">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label">Nama Kata<small><sup><i class="fa fa-star" style="color: red"></i></sup></small></label>
            <div class="col-sm-9">
              <input name="nama_kata" type="text" class="form-control" required>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">Arti Kata<small><sup><i class="fa fa-star" style="color: red"></i></sup></small></label>
            <div class="col-sm-9">
              <input name="arti_kata" type="text" class="form-control" required>
            </div>
          </div>
        </div>
      ...
      <div class="modal-body">
        <form method="POST" class="form-horizontal" role="form">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label">Nama Kata<small><sup><i class="fa fa-star" style="color: red"></i></sup></small></label>
            <div class="col-sm-9">
              <input name="nama_kata" type="text" class="form-control" value="{{ $data->nama_kata }}" required>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">Arti Kata<small><sup><i class="fa fa-star" style="color: red"></i></sup></small></label>
            <div class="col-sm-9">
              <input name="arti_kata" type="text" class="form-control" value="{{ $data->arti_kata }}" required>
            </div>
          </div>
        </div>
        <div class="modal-footer bordered">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" class="form-horizontal" role="form">
          ...
          {{ method_field('DELETE') }} 
          {{ csrf_field() }}       
          <center>Data <strong>{{ $data->nama_kata }}</strong> Akan Dihapus, Apakah Anda Yakin?</center>
        </div>
        <div class="modal-footer bordered">
